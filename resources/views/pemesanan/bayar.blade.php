        ...
        <div class="bg-white rounded-2xl ring-1 ring-gray-100 p-8 shadow-xl">
            ...
            <div class="bg-gray-50 rounded-xl p-4 mb-6 border border-dashed border-gray-200">
                ...
                <div class="flex items-center justify-between pt-3">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-xs text-gray-500">(Pastikan Midtrans Pop-up diblokir)</p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center">
                <button id="payBtn" type="button" 
                    ...
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-9 5h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    Bayar Sekarang
                </button>
            </div>
            ...
            <div id="snapError" class="hidden mt-6 text-sm rounded-xl bg-rose-50 text-rose-700 ring-1 ring-rose-200 px-4 py-3 font-medium">
                <svg class="w-4 h-4 inline mr-1 -mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                <span></span>
            </div>
            ...
            <div class="mt-6 border-t border-gray-100 pt-6 grid grid-cols-2 gap-y-3 text-sm">
                ...
                <p class="text-gray-800 font-semibold text-right">Rp {{ number_format($pesan->jenisTes->biaya ?? 0, 0, ',', '.') }}</p>
